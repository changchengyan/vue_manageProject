...
let Lunar = {
    ...
    betweenSolarDays: function(year, month, day, l_month, l_day) {
        ...
        date1.setFullYear(year),date1.setMonth(month),date1.setDate(day);
        date2.setFullYear(year),date2.setMonth(l_month),date2.setDate(l_day);
    ...
    toLunar: function(year, month, day) {
        ...
        var date = this.betweenSolarDays(year, month, day, yearData[1], yearData[2]);
        return this.lunarByBetween(year, date);
    },
    //转换公历
    //@param year 阴历-年
