        ...
        <div class="wraper">
            <div class="select-items" v-if="toggoleShowProModel">
                ...
                <div class="projects">
                    <div class="item" v-for="(item, index) in selectProject" :key="index"
                         @click="selectSub_item(index, item.code)">
            ...
            <div class="main-content">
                <div class="params-item">
                    ...
                    <div class="row">
                        <div class="col"><span class="required">*</span> <span>测点编码:</span></div>
                        <div class="col two-com">
                            <el-input :disabled="ifFromEdit" clearable placeholder="请输入监测点编码"
                                      @blur="getSiteCodeChange" v-model="postData.stcd"></el-input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"><span class="required">*</span><span>测点名称:</span></div>
                        <div class="col">
                            <el-input clearable placeholder="测点名称" v-model="postData.name"
                                      @change="get_name_len"></el-input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"><span>监测项类型:</span></div>
                        <div class="col">
                            <el-radio :disabled="ifFromEdit" v-model="postData.moniType" @change="showThisRadio"
                                      label="3">流量
                            </el-radio>
                            <el-radio :disabled="ifFromEdit" v-model="postData.moniType" @change="showThisRadio"
                                      label="2">水压
                    ...
                    <div class="row">
                        <div class="col"><span><span class="required">*</span>状态:</span></div>
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col"><span class="required">*</span><span>监测仪器编号:</span></div>
                        <div class="col">
                            <el-input placeholder="请输入检测仪器编号" clearable v-model="postData.deviceCode"
                                      @change="get_deviceCode_len"></el-input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"><span class="required">*</span><span>东经:</span></div>
                        <div class="col">
                            <el-input v-model="postData.lgtd" @change="isLgtd($event,'lgtd')"
                                      placeholder="请输入经度"></el-input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col"><span class="required">*</span><span>北纬:</span></div>
                        <div class="col">
                            <el-input v-model="postData.lttd" @change="isLttd($event,'lttd')"
                ...
                <template v-if="postData.moniType == '1'">
                    <div class="params-item">
                        <div class="detectionItem"><span @click="showProgectsModel">选择检测项</span></div>
                                    ...
                                    <tr :key="item.code" v-if="item.itemFlag == true">
                                        ...
                                        <td>
                                            <template v-if="item.name=='浊度'">
                                                <el-input style="width:calc(100% - 60px)" v-model="item.vmax"
                                            ...
                                            <template v-if="item.name=='PH'">
                                                <el-input style="width:calc(50% - 60px)" v-model="item.vmin"
                                                          @change="ifValid($event,i+'-vmin')"
                                                          placeholder="最小值"></el-input>
                                                (mg/L)
                                                <span>~</span>
                                                <el-input style="width:calc(50% - 60px)" v-model="item.vmax"
                                                          @change="ifValid($event,i+'-vmax')"
                                                          placeholder="最大值"></el-input>
                                                (mg/L)
                                            </template>
                ...
                <div class="params-item">
                    ...
                    <template v-if="postData.moniType == '2'">
                        <div class="row">
                            ...
                            <div class="col times">
                                <el-input placeholder="水压" @change="ifValid($event,'vmax')" v-model="postData.vmax"
                                          clearable></el-input>MPa
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"><span>水压下限:</span></div>
                            <div class="col times">
                                <el-input placeholder="水压" @change="ifValid($event,'vmin')" v-model="postData.vmin"
                                          clearable></el-input> MPa
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col only-input">
                                <el-input placeholder="水压突变" @change="ifValid($event,'sblxsz')"
                                          v-model="postData.sblxsz" clearable></el-input>MPa
                            </div>
                        </div>
                    </template>
                    <template v-if="postData.moniType == '3'">
                        <div class="row">
                            ...
                            <div class="col times">
                                <el-input placeholder="流量" v-model="postData.vmax" @change="ifValid($event,'vmax')"
                                          clearable></el-input>m³/s
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"><span>流量下限:</span></div>
                            <div class="col times">
                                <el-input placeholder="流量" v-model="postData.vmin" @change="ifValid($event,'vmin')"
                                          clearable></el-input>m³/s
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col only-input">
                                <el-input placeholder="流量突变" @change="ifValid($event,'sblxsz')"
                                          v-model="postData.sblxsz" clearable></el-input>
                                m³/s
                            </div>
                        </div>
                    </template>
                    <template v-if="postData.moniType == '4'">
                        <div class="row">
                            ...
                            <div class="col times">
                                <el-input placeholder="水位" v-model="postData.vmax" @change="ifValid($event,'vmax')"
                                          clearable></el-input>&nbsp;&nbsp;m
                            </div>
                        </div>
                        <div class="row">
                            <div class="col"><span>水位下限:</span></div>
                            <div class="col times">
                                <el-input placeholder="水位" v-model="postData.vmin" @change="ifValid($event,'vmin')"
                                          clearable></el-input>&nbsp;&nbsp;m
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col only-input">
                                <el-input placeholder="水位突变" @change="ifValid($event,'sblxsz')"
                                          v-model="postData.sblxsz" clearable></el-input>m
                            </div>
                        </div>
                    </template>
                    <div class="row">
                        ...
                        <div class="col only-input">
                            <el-input v-model="postData.deviceOffline" @change="ifValid($event,'deviceOffline')"
                                      placeholder="设备离线时长" clearable></el-input>h
                        </div>
                    </div>
                </div>
            </div>
            ...
            <dse-save-status :showModel="ifShowModel" :content="fetchContent" @delThis="closeModel" :type="modelType"
                             :flag="status" @sureDelThis="configDel"/>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            updateMonitor_(params) {
                ...
                let temp_data = {
                    ...
                    'deviceOffline': that.postData.deviceOffline
                };
                ...
                } else if (this.postData.moniType == '2') {
                    temp_data.vtx = that.postData.vtx;
                    temp_data.vmax = that.postData.vmax;
                    temp_data.vmin = that.postData.vmin;
                    temp_data.sblxsz = that.postData.sblxsz;

                } else if (this.postData.moniType == '3') {
                    temp_data.vtx = that.postData.vtx;
                    temp_data.vmax = that.postData.vmax;
                    temp_data.vmin = that.postData.vmin;
                    temp_data.sblxsz = that.postData.sblxsz;
            ...
            isLgtd(val,type){
                ...
                this.valid_number = flag;
                if (!flag) {
                    this.$message.error('您输入的经度有误或者最多保留六位小数!');
                    this.postData[type] = '';
                }
            ...
            isLttd(val,type){
                ...
                this.valid_number = flag;
                if (!flag) {
                    this.$message.error('您输入的纬度有误或者最多保留六位小数!');
                    this.postData[type] = '';
                }
                return flag;
            }
        ...
        created() {
            ...
            if (temp) {
                ...
                this.getGcByAreaCode_(temp.prtype);
