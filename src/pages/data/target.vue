	...
	<div class="history">
				...
				<div class="globalHandle">
					<el-form :inline="true" :model="getList" class="form">
						...
						<el-form-item label="模糊搜索:">
							<el-input v-model="getList.keyword" title="请输入供水保障率、水质达标率、自来水普及率、集中供水率" placeholder="供水保障率、水质达标率、自来水普及率、集中供水率" @keyup.enter.native="onHandleSearch"></el-input>
						</el-form-item>
		...
		<dse-normal-model :tips="model.tips" :modelFlag="model.flag" :onHandleModelClose="onHandleModelClose" class="fnModel">
			<el-form :model="updateOrSave" :rules="rules" ref="updateOrSave" label-width="150px" class="modelRuleForm">
				...
				<el-form-item label="指标日期" prop="tm" ><el-date-picker v-model="updateOrSave.tm" value-format="yyyy-MM-dd" type="date" placeholder="请选择时间日期" ></el-date-picker></el-form-item>
		...
		methods: {
			...
			onHanldeCreate() {
				...
				this.updateOrSave = {
					...
					tm:this.$days().format('YYYY-MM-DD'),
					gsbzl: '', // 供水保障率
					szdbl: '', // 水质达标率
					zlspjl: '', // 自来水普及率
					jzgsl: '' // 集中供水率
