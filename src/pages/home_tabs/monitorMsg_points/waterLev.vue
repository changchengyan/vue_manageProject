        ...
        mounted(){
            ...
            waterLev.setOption({
                ...
                series: [{
                    ...
                    barWidth: '10%',
                    data:  [
                        [ new Date().getTime()-18000000 ,32 ],
                        [ new Date().getTime()-15000000 ,31.5 ],
                        [ new Date().getTime()-12000000 ,31 ],
                        [ new Date().getTime()-9000000 ,33 ],
                        [ new Date().getTime()-6000000 ,31 ],
                        [ new Date().getTime()-3000000 ,31.8 ]
                    ]
                }]
            });
        },
